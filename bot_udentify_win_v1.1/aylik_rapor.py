...
def start_writing_on_docx(firma,magza_statik_dosya_location_ismi,magaza_id_no,ilk_tarih,son_tarih,magaza_id_yogunluk,karsilastirilacak_isim_listesi):
    ...
    hm1 = 'sag ust'  #heatmap.find_where_is_everyone ( os.path.join ( BASE_DIR, f'{magza_statik_dosya_location}/isi1_deneme.png' ) )
    print ( 'hadi bakalim' )
    print ( hm1 )
    hm2 = 'sag ust'  #heatmap.find_where_is_everyone ( os.path.join ( BASE_DIR, f'{magza_statik_dosya_location}/isi1_deneme.png' ) )
    print ( 'hadi bakalim' )
    print ( hm2 )
    hm3 = 'sag ust'  #heatmap.find_where_is_everyone ( os.path.join ( BASE_DIR, f'{magza_statik_dosya_location}/isi1_deneme.png' ) )
    print ( 'hadi bakalim' )
    print ( hm3 )
    hm4 = 'sag ust'  #heatmap.find_where_is_everyone ( os.path.join ( BASE_DIR, f'{magza_statik_dosya_location}/isi1_deneme.png' ) )
    print ( 'hadi bakalim' )
    print ( hm4 )
    hm5 = 'sag ust'  #heatmap.find_where_is_everyone ( os.path.join ( BASE_DIR, f'{magza_statik_dosya_location}/isi1_deneme.png' ) )
    print ( 'hadi bakalim' )
    print ( hm5 )
    hm6 = 'sag ust'  #heatmap.find_where_is_everyone ( os.path.join ( BASE_DIR, f'{magza_statik_dosya_location}/isi1_deneme.png' ) )
    print ( 'hadi bakalim' )
    print ( hm6 )
