...
def dosya_yaratici(magaza,BASE_DIR):
    ...
    dosya_yolu = os.path.join ( BASE_DIR, f"bot_udentify_win_v1.1/firms/{gereken_dosya}" )
    print("hata sebebi")
    print(magaza)
    print ( dosya_yolu )
    ...
    dosya_statik_resimler_yolu = os.path.join ( BASE_DIR, f"bot_udentify_win_v1.1/firms/{gereken_dosya}/Statik {gereken_dosya_ismi}" )
    ...
    src_dir = f"{BASE_DIR}/bot_udentify_win_v1.1/statik_resimler"  ### burayi statik yapmalisin
    dst_dir = os.path.join ( BASE_DIR, f"bot_udentify_win_v1.1/firms/{magaza[0]}/Statik {magaza[1]}")
