...
def start_writing_on_docx(firma, magza_statik_dosya_location_ismi, magaza_id_no, ilk_tarih, son_tarih,
                          magaza_id_yogunluk, karsilastirilacak_isim_listesi, isi_tablosu_liste):
    global global_test
    ...
    performans_tablosu_listesi = request1.main_2_7_performans_tablosu_alansal ( magaza_id_no, ilk_tarih, son_tarih,
                                                                                "Count" )
    ...
    hafta_ici_degerler_2_8, haftasonu_degerleri_2_8 = request1.gunleri_classifiye_et ( gunler_2_8 )[0], \
                                                      request1.gunleri_classifiye_et ( gunler_2_8 )[1]
    ...
    hafta_ici_ortalama_2_8, haftasonu_ortalama_2_8 = \
    request1.hafta_ici_hafta_sonu_ortalamalar ( hafta_ici_degerler_2_8, haftasonu_degerleri_2_8,
                                                gunler_ve_musteri_2_8 )[0], \
    request1.hafta_ici_hafta_sonu_ortalamalar ( hafta_ici_degerler_2_8, haftasonu_degerleri_2_8,
                                                gunler_ve_musteri_2_8 )[1]
    ...
    artis_2_8 = request1.hafta_ici_hafta_sonu_buyukluk_karsilastirmasi ( hafta_ici_ortalama_2_8,
                                                                         haftasonu_ortalama_2_8 )
    ...
    hafta_ici_hafta_sonu_oranlari_2_8 = request1.hafta_ici_hafta_sonu_oranlari ( yogunlugu_fazla_olan_tarihler_2_8[0],
                                                                                 yogunlugu_fazla_olan_tarihler_2_8[1] )

    print ( "deneme11111122" )
    print ( performans_tablosu_listesi )
    edinme_hunisi_yuzde = request1.main_2_8_edinme_hunisi ( performans_tablosu_listesi[0][3], ilk_tarih,
                                                            son_tarih )  # burayı a veya b ye goree ayarlayabılıyoruz
    ...
    document.add_picture ( os.path.join ( BASE_DIR, f"{magza_statik_dosya_location}/{firma}_logo.png" ),
    ...
    p = document.add_paragraph (
        f"Bu raporun amacı {magaza_adi} mağazasının belirtilen {tarih} aralığındaki performans metrikleri ({baslik_adlari}) üzerinde yapılan analizler sonucu elde edilen bilgiyi sağlamaktır." )
    # magzalarinin
    ...
    ee_o = os.path.join ( BASE_DIR,
                          f"{magza_statik_dosya_location}/Giren_Kişi_Sayısı_gunluk.png" )  # toplam_kisi_sure.png di degisitii !
    ...
    document.add_paragraph (
        f"Hafta sonu mağazaya gelen ortalama ziyaretçi sayısı, hafta içinin {hafta_ici_hafta_sonu_musteri_orani} katıdır.",
        style='List Bullet'
    )
    ...
    document.add_picture ( os.path.join ( BASE_DIR, f"{magza_statik_dosya_location}/Giren_Kişi_Sayısı_saatlik.png" ),
    ...
    document.add_picture (
        os.path.join ( BASE_DIR, f"{magza_statik_dosya_location}/En_Çok_Vakit_Geçirilen_Alanlar_kişi_sn_saatlik.png" ),
        width=Inches ( 4.5 ), height=Inches ( 2.95 ) )
    last_paragraph = document.paragraphs[-1]  # resimleri ortalamak icin
    last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    document.add_picture ( os.path.join ( BASE_DIR,
                                          f"{magza_statik_dosya_location}/En_Çok_Ziyaret_Edilen_Alanlar_kişi_adet_saatlik.png" ),
                           width=Inches ( 4.5 ), height=Inches ( 2.95 )
                           )
    last_paragraph = document.paragraphs[-1]  # resimleri ortalamak icin
    last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    document.add_picture ( os.path.join ( BASE_DIR, f"{magza_statik_dosya_location}/yogunluk_haritasiyogunluk.png" ),
                           width=Inches ( 6 ), height=Inches ( 3.43 ) )
    last_paragraph = document.paragraphs[-1]  # resimleri ortalamak icin
    last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    document.add_picture ( os.path.join ( BASE_DIR, f"{magza_statik_dosya_location}/yogunluk_haritasiYoğunluk_m2.png" ),
                           width=Inches ( 6 ), height=Inches ( 3.34 ) )
    last_paragraph = document.paragraphs[-1]  # resimleri ortalamak icin
    last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    document.add_paragraph (
        f"Metre kare başına düşen yoğunluklar incelendiğinde, bazı alanlarda bu oranın 1’den küçük olduğu görülür. Bu, birim metre kare başına birim yoğunluktan daha az yoğunluk düştüğünü gösterir.  Birçok alanda metre kare başına düşen yoğunluk 1’in altında kalmıştır. Örneğin; {yogunlugu_1_in_ustundekiler[0].title ()}, {yogunlugu_1_in_ustundekiler[1].title ()}, {yogunlugu_1_in_ustundekiler[2].title ()} alanları en düşük metre kare başına düşen yoğunluk oranına sahiptir.",
        style='List Bullet'
    )
    ...
    document.add_paragraph (
        f"Bazı alanlarda ise bu oran 1’in üstündedir. Yani, birim metre kare başına birim yoğunluktan daha fazlası düşmüştür. Örneğin; {listeyy} alanları.",
        style='List Bullet'
    )
    ...
    tablo_satir_sayisi = (
                round ( (len ( isi_tablosu_liste ) + 1.01) / 2 ) - 1)  # math.ceil kullanmamak icin 0.51 yaptim
    ...
    document.add_picture ( os.path.join ( BASE_DIR, f"{magza_statik_dosya_location}/performans_tablosu_final.png" ),
    ...
    document.add_paragraph (
        f'Kişi sayısı en çok artan alan %{kisi_sayisi2_7_deger} artış ile {kisi_sayisi2_7_isim} alanı,',
        style='List Bullet'
    )

    document.add_paragraph (
        f'Geçirilen süresi en çok artan alan %{gecirilen_sure_2_7_deger} artış ile {gecirilen_sure_2_7_isim} alanı,',
        style='List Bullet'
    )
    document.add_paragraph (
    ...
    document.add_paragraph (
        f'En çok zaman geçirilen alan ortalama {en_cok_zaman_2_7_deger} saniye ile {en_cok_zaman_2_7_isim} alanı,',
        style='List Bullet'
    )
    document.add_paragraph (
        f'En çok ziyaret edilen alan günde ortalama {performans_tablosu_listesi[1][3]} kişi ile {performans_tablosu_listesi[0][0].title ()} alanı olmuştur.',
        style='List Bullet'
    )
    ...
    p = document.add_paragraph (
        f"Mağaza içerisindeki en yoğun alan olan {performans_tablosu_listesi[0][0].title ()} alanının detayına inildiğinde;" )

    document.add_picture ( os.path.join ( BASE_DIR,
                                          f"{magza_statik_dosya_location}/Alana_Giriş_Sayısı_&_Ortalama_Geçirilen_Süre_gunluk.png" ),
                           width=Inches ( 6 ), height=Inches ( 2 ) )
    last_paragraph = document.paragraphs[-1]  # resimleri ortalamak icin
    last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
    p = document.add_paragraph (
        f"({performans_tablosu_listesi[0][0].title ()} Alanı Toplam Kişi Ve Günlük Süre Grafiği)" )
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER

    document.add_paragraph (
        f'Günlük kişi süre grafiği incelendiğinde, hafta sonu mağazaya gelen ortalama kişi sayısı hafta sonuna göre {artis_2_8} Bu oran {katsayi_2_8} katıdır.',
        style='List Bullet'
    )
    ...
    document.add_picture ( os.path.join ( BASE_DIR,
                                          f"{magza_statik_dosya_location}/Alana_Giriş_Sayısı_&_Ortalama_Geçirilen_Süre_saatlik.png" ),
                           width=Inches ( 6 ), height=Inches ( 2 ) )
    last_paragraph = document.paragraphs[-1]  # resimleri ortalamak icin
    last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
    p = document.add_paragraph (
        f"({performans_tablosu_listesi[0][0].title ()} Alanı Toplam Kişi Ve Saatlik Süre Grafiği)" )
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER

    document.add_paragraph (
        f'Saatlik kişi süre grafiği incelendiğinde mağazaya en çok sayıda ziyaretçinin geldiği zaman aralığının {artisin_oldugu_sure_2_8} saatleri arası olduğu görülür.',
        style='List Bullet'
    )
    ...
    document.add_paragraph (
        f'Kişi sayısı ile süre korelasyonu {korelasyon_degeri_2_8} dir, yani {korelasyon_turu} vardır.',
        style='List Bullet'
    )
    ...
    document.add_picture ( os.path.join ( BASE_DIR,
                                          f"{magza_statik_dosya_location}/Alana_Giriş_Sayısı_&_Ortalama_Geçirilen_Süre_yogunluk_gunluk.png" ),
                           width=Inches ( 6 ), height=Inches ( 2 ) )
    last_paragraph = document.paragraphs[-1]  # resimleri ortalamak icin
    last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
    p = document.add_paragraph (
        f"({performans_tablosu_listesi[0][0].title ()} Alanı Yoğunluk Ve Yoğunluk Ortalaması Grafiği)" )
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER

    document.add_paragraph (
        f'Yoğunluk grafiğinde, yoğunluğun ortalamanın üstünde ve altında kaldığı günler görülmektedir. Yoğuluğun arttığı tarihler {request1.list_to_string ( ortalamanin_ustundeki_yogunluklar_2_8 )} olarak gözükmektedir. Yoğunluğun arttığı günlerde, satışın da artması beklenir.',
        style='List Bullet'
    )
    ...
    p = document.add_paragraph (
        f"{performans_tablosu_listesi[0][0].title ()} alanının performans değişimi incelendiğinde;" )

    document.add_picture ( os.path.join ( BASE_DIR, f"{magza_statik_dosya_location}/performans_tek0.png" ),
                           width=Inches ( 6 ), height=Inches ( 0.35 ) )
    last_paragraph = document.paragraphs[-1]  # resimleri ortalamak icin
    last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
    p = document.add_paragraph (
        f"({performans_tablosu_listesi[0][0].title ()} Alanı Yüzdelik Performans Değişimi Grafiği)" )
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
        ...
        if kişi_sayisi_artisi_2_8 > 0:
            if gecirilen_sure_artisi_2_8 > 0:
                if yogunluk_artisi_2_8 > 0:
                    return [
                        f'İlgili alanda, bir önceki tarih aralığına göre hem kişi sayısının hem de geçirilen sürenin sırasıyla {kişi_sayisi_artisi_2_8}% ve {gecirilen_sure_artisi_2_8}% artmasına bağlı olarak yoğunluk {yogunluk_artisi_2_8}% artmıştır.',
                        1]
                else:
                    return [
                        f'İlgili alanda, bir önceki tarih aralığına göre hem kişi sayısının hem de geçirilen sürenin sırasıyla {kişi_sayisi_artisi_2_8}% ve {gecirilen_sure_artisi_2_8}% artmasına bağlı olarak yoğunluk {yogunluk_artisi_2_8}% azalmıştır.',
                        0]
            else:
                if yogunluk_artisi_2_8 > 0:
                    return [
                        f'İlgili alanda, bir önceki tarih aralığına göre kişi sayısı {kişi_sayisi_artisi_2_8}% artmıştır, geçirilen süre  {gecirilen_sure_artisi_2_8}% ile azalmıştır bunların etkisiyle; yoğunluk {yogunluk_artisi_2_8}% artmıştır.',
                        1]
                else:
                    return [
                        f'İlgili alanda, bir önceki tarih aralığına göre kişi sayısı {kişi_sayisi_artisi_2_8}% artmıştır, geçirilen süre  {gecirilen_sure_artisi_2_8}% ile azalmıştır bunların etkisiyle; yoğunluk {yogunluk_artisi_2_8}% azalmıştır.',
                        0]
            ...
            if gecirilen_sure_artisi_2_8 > 0:
                if yogunluk_artisi_2_8 > 0:
                    return [
                        f'İlgili alanda, bir önceki tarih aralığına göre kişi sayısı {kişi_sayisi_artisi_2_8}% ile azalmıştır, geçirilen süre  {gecirilen_sure_artisi_2_8}% ile artmıştır bunların etkisiyle; yoğunluk {yogunluk_artisi_2_8}% artmıştır.',
                        1]
                else:
                    return [
                        f'İlgili alanda, bir önceki tarih aralığına göre kişi sayısı {kişi_sayisi_artisi_2_8}% ile azalmıştır, geçirilen süre  {gecirilen_sure_artisi_2_8}% ile artmıştır bunların etkisiyle; yoğunluk {yogunluk_artisi_2_8}% azalmıştır.',
                        0]

            else:
                if yogunluk_artisi_2_8 > 0:
                    return [
                        f'İlgili alanda, bir önceki tarih aralığına göre kişi sayısı {kişi_sayisi_artisi_2_8}% ile azalmıştır, geçirilen süre  {gecirilen_sure_artisi_2_8}% ile azalmıştır bunların etkisiyle; yoğunluk {yogunluk_artisi_2_8}% artmıştır.',
                        1]
                else:
                    return [
                        f'İlgili alanda, bir önceki tarih aralığına göre kişi sayısı {kişi_sayisi_artisi_2_8}% ile azalmıştır, geçirilen süre  {gecirilen_sure_artisi_2_8}% ile azalmıştır bunların etkisiyle; yoğunluk {yogunluk_artisi_2_8}% azalmıştır.',
                        0]
    ...
    p = document.add_paragraph (
        f"o Yoğunluk {paragraf_3} satışın da artması, alandaki potansiyelin yükselmekte olduğunu gösterir." )
    p = document.add_paragraph ( f"o Satış hedefini daha da yükseltmeye yönelik aksiyon alınmalıdır." )
    p = document.add_paragraph (
        f"o Önceki tarih aralığına göre ilgi oranı da {ilgi_orani_artisi_2_8}% {ilgi_orani_durumu_2_8}. " )
    p = document.add_paragraph (
        f"o Bu alanda ilgi oranı {ilgi_hali_2_8} ve yoğunluk {yogunluk_hali_2_8} satış da arttığına göre bu alanda geçirilen sürenin satışa olan etkisi incelenmelidir." )
    p = document.add_paragraph (
        f"o Satışı daha da arttırmak için ziyaretçilerin alanda daha fazla zaman geçirmesi sağlanabilir." )
    p = document.add_paragraph (
        f"o Bunun için; personel ilgisi, ürün fiyat dengesi, ürün çeşitliliği gözden geçirilebilinir " )
    ...
    document.add_page_break ()
    document.add_heading ( 'Mağaza Özeti', 0 )
    document.add_paragraph (
        f'Hafta sonu gerçekleşen sokağa çıkma yasağı nedeniyle (11/01/2021-15/01/2021) ve (18/01/2021-22/01/2021) tarihleri kendi aralarında karşılaştırılmıştır.'
    )
    document.add_heading ( '2.1 Satış Tutarı', level=1 )
    p = document.add_paragraph (
        f"(18/01/2021-22/01/2021) tarihli süreçte toplam satış tutarı (120,874.49 TL) bir önceki hafta olan(11/01/2021-15/01/2021) tarihli satış tutarına (134,073.37 TL) göre %9.84 düşüş yaşamıştır. Mağaza içi ortalama satış tutarı bir kategori için 5,036.44 TL’dir."
    )
    p = document.add_paragraph (
        f""
    )
    p = document.add_paragraph (
        f"Toplam satış tutarına göre ilk 10 kategori aşağıdaki tabloda gösterilmiştir."
    )

    document.add_paragraph (
        f'İlk 10 kategori incelendiğinde ‘ACC.’ kategorisi hariç her kategoride temas açısından bir önceki haftaya göre artış yaşanmıştır',
        style='List Bullet'
    )
    document.add_paragraph (
    ...
    document.add_paragraph (
        f' {tarih} tarih aralığında kasa alanına uğrayan toplam ziyaretçi sayısı 8 061’dir. Kasa alanında 15 saniye, 120 saniye vakit geçiren ziyaretçiler aşağıdaki tabloda gösterilmiştir.'
    )
    ...
    row[3].text = '3 dakikayı aşan kişi'
    ...
    document.add_paragraph (
        f'Kasada bekleme süresi arttıkça müşterinin ürünü almama ihtimali artmaktadır, bu nedenle 120 saniye üzeri bekleme yapan müşteri sayısı ile fiş sayısı kıyaslandığında kaç kişilik kayıp olduğu anlaşılır ve mağaza sepet ortalamasına bakılarak satış kaybı miktarı belirlenebilir.'
    )
...
start_writing_on_docx ( "under armour", "under armour akasya", 240, ilk_tarih, son_tarih, 161,
                        [["BOYS", "GIRLS"], ["WOMEN'S RUN", "MEN'S RUN"]],
                        ['Ana Giriş', 'Cam 7', 'Cam 8', 'Run', 'Youth', 'Giriş', 'Train', 'Train Ön'] )
